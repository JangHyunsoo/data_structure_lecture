...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, listEmptyInitializationTest)
{
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, PushAndPopBackTest)
{
	SingleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, PushAndPopBackTest_EXTRA)
{
	SingleUnsortedLinkedList list;
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, PushAndPopFrontTest)
{
	SingleUnsortedLinkedList list;
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, PushPopBackFrontTest)
{
	SingleUnsortedLinkedList list;
	list.pushFront(3);
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, listInitializationTest)
{
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, findTest){
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, removeFirstTest){
	SingleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
	list.pushBack(7);
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, removeAllTest){
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, iteratorTest){
	SingleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
	list.pushBack(7);
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, IndexOperator){
	SingleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
	ASSERT_EQ(list[1], 5);
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, clearTest){
	SingleUnsortedLinkedList list{1,3,1,1,3,4,5,4,4,6};
	list.clear();
	ASSERT_TRUE(list.isEmpty());
	list.pushBack(4);
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, Big5)
{
...
TEST(SingleUnsortedLinkedList_Duplicate_WithoutTail, reverseTest){
	SingleUnsortedLinkedList list{1,2,3,4,5,6};
	list.reverse();
	std::string output = "";
	for(auto n: list)
			output += std::to_string(n)+",";
	ASSERT_EQ(output,"6,5,4,3,2,1,");
}
