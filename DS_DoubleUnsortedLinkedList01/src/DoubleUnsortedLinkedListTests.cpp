...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, listEmptyInitializationTest)
{
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, PushAndPopBackTest)
{
	DoubleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, PushAndPopBackTest_EXTRA)
{
	DoubleUnsortedLinkedList list;
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, PushAndPopFrontTest)
{
	DoubleUnsortedLinkedList list;
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, PushPopBackFrontTest)
{
	DoubleUnsortedLinkedList list;
	list.pushFront(3);
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, listInitializationTest)
{
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, findTest){
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, removeFirstTest){
	DoubleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
	list.pushBack(7);
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, removeAllTest){
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, iteratorTest){
	DoubleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
	list.pushBack(7);
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, IndexOperator){
	DoubleUnsortedLinkedList list;
	list.pushBack(3);
	list.pushBack(5);
	ASSERT_EQ(list[1], 5);
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, clearTest){
	DoubleUnsortedLinkedList list{1,3,1,1,3,4,5,4,4,6};
	list.clear();
	ASSERT_TRUE(list.isEmpty());
	list.pushBack(4);
...
TEST(DoubleUnsortedLinkedList_Duplicate_WithoutTail, Big5)
{
